 ...
 * @param {Array} [parameters.additionalSections]
...
module.exports = function (parameters = {}) {
    ...
    additionalSections.forEach(section => {
        const index = section.index || sections.length;
        const deleteCount = 0;
        const sectionPair = [h2(section.header), section.body || placeholder];

        sections.splice(index, deleteCount, sectionPair);
    });
