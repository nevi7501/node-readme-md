...
------------
### Added
- Added `parameters.config['prefer-yarn']` argument that produces install section example variants.
...
[Unreleased]: https://github.com/jbenner-radham/node-readme-md/compare/v0.3.0...HEAD
